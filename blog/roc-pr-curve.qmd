...
: The Confusion Matrix {#tbl-confusion-matrix .striped .hover}
...
```{python}
#| label: fig-pr-interp
#| fig-cap: "PR space conversion of ROCCH."
#| fig-align: center
...
$$
\begin{align*}
\text{PrecG}&=\frac{\text{Prec}-\pi}{(1-\pi)\text{Prec}}, \\
