...
RobustScaler: "[*RobustScaler*](https://scikit-learn.org/stable/modules/generated/sklearn.preprocessing.RobustScaler.html)"
LabelEncoder: "[*LabelEncoder*](https://scikit-learn.org/stable/modules/generated/sklearn.preprocessing.LabelEncoder.html)"
OneHotEncoder: "[*OneHotEncoder*](https://scikit-learn.org/stable/modules/generated/sklearn.preprocessing.OneHotEncoder.html)"
OrdinalEncoder: "[*OrdinalEncoder*](https://scikit-learn.org/stable/modules/generated/sklearn.preprocessing.OrdinalEncoder.html)"
PowerTransformer: "[*PowerTransformer*](https://scikit-learn.org/stable/modules/generated/sklearn.preprocessing.PowerTransformer.html)"
QuantileTransformer: "[*QuantileTransformer*](https://scikit-learn.org/stable/modules/generated/sklearn.preprocessing.QuantileTransformer.html)"
KBinsDiscretizer: "[*KBinsDiscretizer*](https://scikit-learn.org/stable/modules/generated/sklearn.preprocessing.KBinsDiscretizer.html)"
SimpleImputer: "[*SimpleImputer*](https://scikit-learn.org/stable/modules/generated/sklearn.impute.SimpleImputer.html)"
KNNImputer: "[*KNNImputer*](https://scikit-learn.org/stable/modules/generated/sklearn.impute.KNNImputer.html)"
IterativeImputer: "[*IterativeImputer*](https://scikit-learn.org/stable/modules/generated/sklearn.impute.IterativeImputer.html)"
---
...
For example, to implement {{< meta StandardScaler >}}, which ensures features have zero mean and unit variance:
...
::: {#tbl-statistics .list-table .striped .hover aligns="c,c,c,c"}
Preprocessors and associated statistics.
...
- - Transformation
  - {{< meta PowerTransformer >}}

    {{< meta QuantileTransformer >}}
  - $\psi(\lambda,x)$
...
- - Discretization
  - {{< meta KBinsDiscretizer >}}
  - $j$ if $T_j\le x<T_{j+1}$
  - Min, Max, Quantile, Mean
...
- - Imputation
  - {{< meta SimpleImputer >}}
    ...
    {{< meta IterativeImputer >}}
  - mean($x$), median($x$), freq($x$)

    mean($k$-NN of $x$)

    RegressionModel($x$)
  - Mean, Quantile, Freq-items
...
- {{< meta KBinsDiscretizer >}} uses [$k$-means clustering](https://en.wikipedia.org/wiki/K-means_clustering).
- {{< meta KNNImputer >}} uses [$k$-nearest neighbors](https://en.wikipedia.org/wiki/K-nearest_neighbors_algorithm).
- {{< meta IterativeImputer >}} uses [Bayesian linear regression](https://en.wikipedia.org/wiki/Bayesian_linear_regression).
