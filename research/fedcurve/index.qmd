...
We evaluate the method using the [Adult dataset](https://archive.ics.uci.edu/dataset/2/adult) and [XGBoost classifier](https://xgboost.readthedocs.io/) in @fig-error. We test both Secure Aggregation (SA) and Distributed Differential Privacy (DDP), varying $Q$ from 4 to 1024 and $\varepsilon\in\{0.1,0.3,1\}$.
